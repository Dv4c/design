...
Висновок: на данній практичній роботі було створено файрфмейм для інтернет-магазину, головна сторінка та сторінки товару використовують інструменти Prototype для реалізації переходів між ними.1